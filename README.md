...
**[0.5] Fixed zoom effect, simplified expressions, polished code. Now when you zoom past zero it flips both the axises. (Basically like zooming in to infinity, then going on the 'other side' (mirror universe?!?))**
